# R6 Creator AI — Detailed Local Guide

> **Development-status note:** This document records locally tested milestones,
> not production reliability. Gameplay-event detection, highlight selection,
> non-destructive editing/export workflows, and Match Replay parsing are active
> development areas. Results from a small controlled fixture or one local replay
> package do not establish general accuracy or compatibility.
...
```text
the folder where you cloned `r6-creator-ai`
```
